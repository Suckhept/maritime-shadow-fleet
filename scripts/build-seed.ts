...
interface CompanyDef extends Omit<Company, "id" | "jurisdictionSourceType"> { id: string; self?: SelfDesig }
...
const companies: CompanyDef[] = [
  ...
  { id: "west-maritime-services-and-trading-inc", name: "West Maritime Services and Trading Inc", imoCompanyNumber: null, jurisdiction: null, describedAsBasedIn: null, addressCountryId: null, registeredAddress: null, taxId: null, registrationNumber: null, lei: null, sourceUrl: SRC.uk20260210 },
...
const others: VesselDef[] = [
  ...
  { name: "Lunar Tide", imo: "9277735", mmsi: null, vesselType: "Oil tanker", flag: "GIN", flagStatus: "listed", yearBuilt: 2004,
    ...
    desig: { listName: "UK Sanctions List", nature: "binding-sanction", program: "The Russia (Sanctions) (EU Exit) Regulations 2019", dateListed: "2025-07-21", status: "active", verifiedAt: "2026-02-10", statusSource: SRC.uk20260210, authorityId: "uk-fcdo", uniqueId: "RUS2841", statementOfReasons: "IMO 9277735 is, has been or is likely to be involved in carrying oil or oil products that originated in Russia from Russia to a third country.", sourceUrl: SRC.uk20260210 } },
];
...
const companiesOut: Company[] = companies.map(({ self, ...c }) => ({
  ...c, jurisdictionSourceType: c.jurisdiction ? ("official-registration-id" as const) : null,
}));
